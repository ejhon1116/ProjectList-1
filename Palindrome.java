...
public class Palindrome
{
  public static void main(String[] args)
  {
    ...
    while(rep > 0)
    {
      ...
      if(isPalindrome(str) == true) JOptionPane.showMessageDialog(null, "The reversed string is: " + reverseString(str) + ".\nIt is the same as the original string: " + str + ".\nTherefore, your string is a palindrome!", "Palindrome Checker", JOptionPane.INFORMATION_MESSAGE);
      else JOptionPane.showMessageDialog(null, "The reversed string is: " + reverseString(str) + ".\nIt is not the same as the original string: " + str + ".\nTherefore, your string is not a palindrome!", "Palindrome Checker", JOptionPane.INFORMATION_MESSAGE);
